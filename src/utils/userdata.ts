...
export const guardarUserBusaId = (id: number) => {
  if (typeof id !== "number") {
    console.error("Token no válido");
    return;
  }
...
export const obtenerUserBusaId = () => {
  try {
    const userId = localStorage.getItem("userid");
    if (userId === null) {
      console.error("No se encontró el ID de usuario en el localStorage");
...
export const eliminarUserBusaId = () => {
  try {
    console.log("se elimino el userid");
...
export const guardarUserBusaNivel = (nivel: number) => {
  if (typeof nivel !== "number") {
    console.error("Nivel no válido");
    return;
  }
...
export const obtenerUserBusaNivel = () => {
  try {
    const userNivel = localStorage.getItem("usernivel");
    if (userNivel === null) {
      console.error("No se encontró el Nivel de usuario en el localStorage");
...
export const eliminarUserBusaNivel = () => {
  try {
    console.log("se elimino el usernivel");
